                    ...
                    <ul style="height:15px">
                        ...
                        <body id="addProduct">
                            ...
                            <div id="addProductForm" class="row justify-content-center rounded">
                                ...
                                <form action="/editReceiptProcess?nameEdit=${param.nameedit}&phoneedit=${param.phoneedit}" method="POST" modelAttribute="ReceiptEdit"
                                    enctype="multipart/form-data">

                                
                                    <input name="nameedit" type="text" class="form-control" value="${param.nameedit}" hidden>
                                    <input name="phoneedit" type="text" class="form-control" value="${param.phoneedit}" hidden>
                                    ...
                                    <div class="form-group">
                                        <label for="phonenumber"class="font-weight-bold" style="float:left;">Phone Number</label>
                                        <input name="phone" path="email" type="text" class="form-control rounded" id="Name"
                                            placeholder="Enter your phone number" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="address"class="font-weight-bold" style="float:left;">Address</label>
                                        <input name="address" path="password" type="text" class="form-control rounded" id="Name"
                                            placeholder="Enter your address" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="detail"class="font-weight-bold" style="float:left;">Detail</label>
                                        <input name="detail" path="password" type="text" class="form-control rounded" id="Name"
                                            placeholder="Enter detail (type: Name, Price ----Amount)" required>
                                    </div>

                                
                                    <div class="form-group">
                                        <label for="phone"class="font-weight-bold" style="float:left;">Total price</label>
                                        <input name="price" path="phone" type="text" class="form-control rounded" id="Price"
                                            placeholder="Enter price" required>
                                    </div>

                                    <input name="status" path="phone" type="text" class="form-control rounded" id="Price"
                                    value="Waiting" hidden>
