              ...
              <header>
                <nav id='cssmenu'>
                  ...
                  <ul style="height:15px">
                    ...
                    <li class="nav_name"><a id="namefromheader" href='#'><img
                          src="/images/user.jpg" width="16"
                          height="16">
                        <% String username=(String)session.getAttribute("
                          tendangnhap" ); if(session!=null){
                          out.print(username); } %>
                        </a>
                        <ul>
                      ...
                      <form
                        action="/addToCart?id=${ProductDetail.productID}&email=${tendangnhap}"
                        method="post">
                            ...
                            <div id="card" class="card">
                              ...
                              <div class="product-content">
                                ...
                                <div class="product-price">
                                  ...
                                  <p class="new-price">Price: <span>${ProductDetail.price}
                                      $</span></p>
                                </div>
                                ...
                                <input type="text" name="name"
                                  value="${ProductDetail.name}" hidden>
                                <input type="text" name="image"
                                  value="${ProductDetail.image}" hidden>
                                <input type="text" name="price"
                                  value="${ProductDetail.price}" hidden>
                                <input type="text" name="productID"
                                  value="${ProductDetail.productID}" hidden>
